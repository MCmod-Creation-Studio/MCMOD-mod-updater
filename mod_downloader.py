        ...
        for i in file_id:
            ...
            if website == "Curseforge":
                ...
                if k["data"]["gameId"] == 432:
                    ...
                    gameType = "Other"
                # 保存Mod元数据
                save_mod_metadata(time, fileName, mcmod_id, downloadUrl, fileDate, gameVersions, releaseType, gameType)
                ...
                # 保存Mod元数据
                save_mod_metadata(time, fileName, mcmod_id, downloadUrl, fileDate, gameVersions,
                                                   releaseType, gameType)
            else:
                raise Exception("未知的网站类型：" + website)
